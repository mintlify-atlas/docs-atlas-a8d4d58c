...
- **Documentation**: Comprehensive guides at [docs.expo.dev](https://docs.expo.dev)
...
<Steps>
  ...
  <Step title="Explore the SDK">
    Browse the [API Reference](https://docs.expo.dev/versions/latest/) to discover what's possible
  </Step>
</Steps>
